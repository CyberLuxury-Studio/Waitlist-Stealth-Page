  ...
  return (
    ...
    >
      ...
      <div className="text-sm font-sans">
        <p className="text-[var(--color-on-surface)] font-medium font-mono text-xs">UPLINK ESTABLISHED</p>
        <p className="text-[var(--color-on-surface-variant)] text-[10px] font-mono">User 0x9A joined the waitlist.</p>
      </div>
    </motion.div>
  );
}
